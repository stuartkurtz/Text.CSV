...
/* package text-csv-0.1.2.6 */
#define VERSION_text_csv "0.1.2.6"
#define MIN_VERSION_text_csv(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "text-csv-0.1.2.6-A1QYiuZC5K0EOAPjOrommi"

#define CURRENT_PACKAGE_KEY "text-csv-0.1.2.6-A1QYiuZC5K0EOAPjOrommi"
